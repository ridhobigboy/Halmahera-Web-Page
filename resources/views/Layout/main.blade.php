        ...
        <section class="projects-section bg-light" id="projects">
            <div class="container px-4 px-lg-5">
                ...
                <div class="row gx-0 mb-5 mb-lg-0 justify-content-center">
                    <div class="col-lg-6"><img class="img-fluid" src="{{asset('Template/assets/img/demo-image-01.jpg')}}" alt="..." /></div>
                    <div class="col-lg-6">
                ...
                <div class="row gx-0 justify-content-center">
                    <div class="col-lg-6"><img class="img-fluid" src="{{asset('Template/assets/img/demo-image-02.jpg')}}" alt="..." /></div>
